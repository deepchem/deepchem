...
seed = 123
np.random.seed(seed)
base_dir = "/Users/staker/Projects/external/deepchem/contrib/atomicconv/feat"
data_dir = os.path.join(base_dir, "scaffold_atomconv")
train_dir = os.path.join(base_dir, "train")
test_dir = os.path.join(base_dir, "test")
pdbbind_dir = "/Users/staker/Projects/external/deepchem/contrib/atomicconv/feat/v2015"

print("Loading ids from %s" % data_dir)
d = dc.data.DiskDataset("/Users/staker/Projects/external/deepchem/contrib/atomicconv/feat/dataset")
d.reshard(24)
ids = d.ids
...
def create_scaffold_indices(pdbbind_dir, base_dir):
  ...
  for ind, pdb_code in enumerate(ids):
    ...
    pdb_subdir = os.path.join(pdbbind_dir, str(pdb_code))
