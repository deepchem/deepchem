...
class PINO(TorchModel):
    """
    Physics-Informed Neural Operator (PINO) for solving PDEs.
    ...
    References: https://arxiv.org/abs/2111.03794
    ...
    **kwargs:
    ...
    def _loss_fn(self, outputs: torch.Tensor, labels: torch.Tensor,
    ...
    def _prepare_batch(
        self, batch: Tuple[np.ndarray, np.ndarray]
