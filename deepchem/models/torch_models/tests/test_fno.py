...
def test_fno_construction():
    ...
    model_1d = FNOModel(in_channels=1,
                        ...
                        dims=1,
                        depth=2)
    assert model_1d is not None, "1D FNO Model construction failed"
    ...
    model_2d = FNOModel(in_channels=2,
                        ...
                        dims=2,
                        depth=3)
    assert model_2d is not None, "2D FNO Model construction failed"
    ...
    model_3d = FNOModel(in_channels=3,
                        ...
                        dims=3,
                        depth=2)
    assert model_3d is not None, "3D FNO Model construction failed"
