      ...
      [[[0.035281046919353284, 0.008003144167344467, 0.019574759682114785],
       ...
       [[0.044817863984029156, 0.03735115980299935, 0.7284544424024718],
        [0.044817863984029156, 0.03735115980299935,
         -0.019545557597528185]]])).all()
  assert (molecule.one_electron_distance == np.array(
      [[0.041133609188854975, 0.7293230651230344],
       [0.7307869899817704, 0.06152868349411048]])).all()
  assert (molecule.two_electron_vector == np.array(
      [[[0.0, 0.0, 0.0],
        [0.009536817064675872, 0.02934801563565488, 0.7088796827203571]],
       [[-0.009536817064675872, -0.02934801563565488, -0.7088796827203571],
        [0.0, 0.0, 0.0]]])).all()
  assert (molecule.two_electron_distance == np.array([[0.0, 0.7095510280981839],
                                                      [0.7095510280981839,
                                                       0.0]])).all()
