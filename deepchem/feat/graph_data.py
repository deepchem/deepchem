...
class GroverBatchGraphData(GraphData):
    """Batch GraphData for Grover graph data"""
    ...
    def __init__(self, graph_list: Sequence[GraphData]):
        ...
        super().__init__(node_features=f_atoms,
