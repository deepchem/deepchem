CheckFeaturizer = {
    ...
    ('muv', 'weave'): ['Weave', 75],
    ('pcba_128', 'logreg'): ['ECFP', 1024],
    ('pcba_128', 'tf'): ['ECFP', 1024],
    ('pcba_128', 'tf_robust'): ['ECFP', 1024],
    ('pcba_128', 'irv'): ['ECFP', 1024],
    ('pcba_128', 'xgb'): ['ECFP', 1024],
    ('pcba_128', 'graphconv'): ['GraphConv', 75],
    ('pcba_128', 'weave'): ['Weave', 75],
...
CheckSplit = {
    ...
    'pcba_128': ['index', 'random', 'scaffold'],
