...
print("\nRunning GP on BBBP (50 generations)...")
...
print(f"\n{'='*40}")
print(f"BBBP AUC:  {auc:.4f}")
print(f"Equation:  {best}")
print(f"{'='*40}")

if auc > 0.60:
    print("Classification fix WORKS!")
elif auc > 0.55:
    print("Marginal — fix works but needs tuning.")
else:
    print("Still broken — AUC near 0.5, debug needed.")