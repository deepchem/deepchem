...
voxelizer = dc.feat.HydrogenBondVoxelizer(box_width=box_width, voxel_width=voxel_width)
features, failures = voxelizer.featurize_complexes(
    core_subset, parallelize=False)
print("features.shape")
print(features.shape)
print("%d failures" % len(failures))
assert features.shape == (n_featurize, voxels_per_edge, voxels_per_edge, voxels_per_edge, 3)
