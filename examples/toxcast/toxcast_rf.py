...
base_data_dir = "/tmp/toxcast_rf"

toxcast_tasks, toxcast_dataset, transformers = load_toxcast(
...
train_dataset, valid_dataset, test_dataset = splitter.train_valid_test_split(
  toxcast_dataset, train_dir, valid_dir, test_dir)
...
toxcast_task_types = {task: "classification" for task in toxcast_tasks}
...
def model_builder(tasks, task_types, model_params, model_dir, verbosity=None):
  return SklearnModel(tasks, task_types, model_params, model_dir,
                      model_instance=RandomForestClassifier(
                          ...
                          n_jobs=-1),
                      verbosity=verbosity)
model = SingletaskToMultitask(toxcast_tasks, toxcast_task_types, params_dict, model_dir,
